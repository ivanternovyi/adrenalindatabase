...
Feature: New user registration
  ...
  Scenario: Register from first try
    ...
    Then I have to see "Шановний Петр Сидорович, , Ваша заявка успішнго прийнята, авторизація вашого членства у ВГО 'Адреналін', надійде на вказану вами поштову скриньку ivanow_kreativ@mail.com. Дякуємо за реєстрацію.""